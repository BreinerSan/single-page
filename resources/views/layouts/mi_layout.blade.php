		            ...
		            <div class="carousel-item active">
		            	<img src="img/slider/bg-1.jpg" alt="">
		              	<div class="carousel-caption text-left">
		                	<h3 class="wow fadeInRight" data-wow-delay="0.2s">O.N.G.</h1>  
		                	<h2 class="wow fadeInRight" data-wow-delay="0.4s">CAPITAL HUMANO</h2>
		                	<h4 class="wow fadeInRight" data-wow-delay="0.6s">La asociación para el Desarrollo de Ocaña y su región</h4>
